...
var paypalApp =
 {
    ...
    PRODUCTION_CLIENT_ID:"Ac9l56PzR_SESGsY8CgPXjrmybBOxvSoLk4LI03fKbDs7AzA5_l512Uo3W7yFps3mj_UDGf0JaI3NMPk",
    SANDBOX_CLIENT_ID:"AUmxvLpoSNs3ACAK2PMzIp1CjSF5l713uOuzN9n0VxQNFKZb0e0wkInYyoXQBJ0a1-MOGlwpozvxzh7k",

    PAYPAL_MERCHANT_NAME:"Nombre tienda",
    PAYPAL_PRIVACITY_POLICY_URL:"https://spykoapp.com/politica-privacidad/",
    PAYPAL_MERCHANT_USER_AGREEMENT_URL:"https://spykoapp.com/terminos-servicio/",
   ...
   createPayment : function (amount) 
   {
    ...
    //var payment = new PayPalPayment(amount, "EUR", paypalApp.PAYPAL_SHORT_DESCRIPTION, "Sale", paymentDetails);

	alert("createPayment: " + paypalApp.PAYPAL_CURRENCY_COD + "--" + paypalApp.PAYPAL_SHORT_DESCRIPTION);
   
    var payment = new PayPalPayment(amount, paypalApp.PAYPAL_CURRENCY_CODE, paypalApp.PAYPAL_SHORT_DESCRIPTION, "Sale");
